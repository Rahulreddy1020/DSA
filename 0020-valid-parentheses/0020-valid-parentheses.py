...
/// then we will check if the stack[-1] which is top element, has any open bracket, if so then we will pop the item. the loop will exit when it sees a open bracket, if not
